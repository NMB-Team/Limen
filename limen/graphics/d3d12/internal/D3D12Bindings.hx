...
class D3D12Bindings {
	@:hlNative("limen", "d3d12_compiler_create")
	public static function compilerCreate():CompilerHandle {
		return null;
	}

	@:hlNative("limen", "d3d12_compiler_compile")
